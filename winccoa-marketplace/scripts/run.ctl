...
//   DebugTN("result of 'clone with default target directory'", client.clone("https://github.com/winccoa/greece_test_addon.git")); // GEHT
...
//   DebugTN("result of 'clone with specified target directory'",client.clone("https://github.com/winccoa/winccoa-ae-js-mcpserver.git", "D:/test"));
  ...
  // pull existing repo
  DebugTN("result of 'pull existing repo'", client.pull("D:/WinCC_OA_Proj/3.21/greece_test_addon")); // GEHT
